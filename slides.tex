...
\begin{frame}{Workshop notes}
  \begin{itemize}\setlength{\itemsep}{3mm}
  \item Serial Chapel \url{https://github.com/razoumov/publish/blob/master/01-base.md}
  \item Task parallelism \url{https://github.com/razoumov/publish/blob/master/02-task-parallelism.md}
  \item Data parallelism \url{https://github.com/razoumov/publish/blob/master/03-domain-parallelism.md}
  \end{itemize}
\end{frame}
